...
public class BuildVars {
    ...
    public static boolean isStandaloneApp() {
        if (standaloneApp == null) {
            standaloneApp = ApplicationLoader.applicationContext != null && "net.voicemod.telegram.web".equals(ApplicationLoader.applicationContext.getPackageName());
        }
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "net.voicemod.telegram.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
