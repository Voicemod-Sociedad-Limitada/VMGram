...
public class VMVoIPToggleButton extends FrameLayout {
    ...
    public VMVoIPToggleButton(@NonNull Context context) {
        this(context, 55f);
    }
    public VMVoIPToggleButton(@NonNull Context context, float radius) {
        super(context);
        this.radius = radius;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        setMinimumWidth((int) (radius * 2 + 10));
        if (drawBackground) {
        ...
        if (currentIconRes != 0) {
            if (drawCross || crossProgress != 0) {
                if (iconChangeColor) {
                    ...
                    icon[0].setColorFilter(new PorterDuffColorFilter(color, PorterDuff.Mode.SRC_IN));
                ...
                for (int i = 0; i < ((replaceProgress == 0 || iconChangeColor) ? 1 : 2); i++) {
                    if (icon[i] != null) {
                        ...
                        if (replaceProgress != 0 && !iconChangeColor && icon[0] != null && icon[1] != null) {
                            ...
                            if (iconChangeColor) {
                                int color = ColorUtils.blendARGB(replaceColorFrom, currentIconColor, replaceProgress);
                                icon[i].setColorFilter(new PorterDuffColorFilter(color, PorterDuff.Mode.SRC_IN));
                                crossPaint.setColor(color);
                            }
                            icon[i].setAlpha(255);
                        }
    ...
    public void setData(int iconRes, int iconColor, int backgroundColor, float selectorAlpha, boolean recreateRipple, String text, boolean cross, boolean animated) {
        ...
        this.selectorAlpha = selectorAlpha;
        //Prevent changing colors when popup is opened
        if (keepColors) {
        ...
        if (!animated) {
            if (iconRes != 0) {
                ...
                icon[0].setColorFilter(new PorterDuffColorFilter(iconColor, PorterDuff.Mode.SRC_IN));
            }
            ...
            if (!iconChangeColor && iconRes != 0) {
                ...
                icon[1].setColorFilter(new PorterDuffColorFilter(iconColor, PorterDuff.Mode.SRC_IN));
            }
            if (!checkable) {
            ...
            replaceAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    iconChangeColor = false;
                    if (!checkable) {
                        VMVoIPToggleButton.this.backgroundColor = animateToBackgroundColor;
                    }
                    replaceProgress = 0f;
                    invalidate();
                }
    ...
    public void changeColors(int backgroundColor, boolean showBackgroundWithAlpha, int iconColor, boolean keepColors) {
        this.backgroundColor = showBackgroundWithAlpha ? ColorUtils.setAlphaComponent(backgroundColor,
                (int) (255 * 0.1f * selectorAlpha)) : backgroundColor;
        this.currentIconColor = iconColor;
        icon[0].setColorFilter(new PorterDuffColorFilter(currentIconColor, PorterDuff.Mode.SRC_IN));
