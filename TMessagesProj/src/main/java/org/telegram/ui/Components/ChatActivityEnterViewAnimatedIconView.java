...
public class ChatActivityEnterViewAnimatedIconView extends RLottieImageView {
    ...
    private enum TransitState {
        ...
        //VOICEMOD -> TUNA -> Transition states of the icon on the text field
        //Using the same icon for every state transition. To get a smooth animation this should be different lottie animations
        TUNA_TO_STICKER(State.TUNA, State.STICKER, R.raw.ic_tuna),
        TUNA_TO_GIF(State.TUNA, State.GIF, R.raw.ic_tuna),
        TUNA_TO_SMILE(State.TUNA, State.SMILE, R.raw.ic_tuna),
        GIF_TO_TUNA(State.GIF, State.TUNA, R.raw.ic_tuna),
        SMILE_TO_TUNA(State.SMILE, State.TUNA, R.raw.ic_tuna),
        STICKER_TO_TUNA(State.STICKER, State.TUNA, R.raw.ic_tuna);
        //END VOICEMOD
