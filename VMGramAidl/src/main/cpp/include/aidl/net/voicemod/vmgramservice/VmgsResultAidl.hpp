...
#ifndef VOICEMODSERVICEAPP_PARCELABLEVCMDRESULT_H
#define VOICEMODSERVICEAPP_PARCELABLEVCMDRESULT_H
...
namespace aidl::net::voicemod::vmgramservice{
    ...
    class VmgsResultAidl{ // TODO: Remove Aidl suffix
...
#endif //VOICEMODSERVICEAPP_PARCELABLEVCMDRESULT_H
